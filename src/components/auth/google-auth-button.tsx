...
export function GoogleAuthButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="inline-flex h-[38px] items-center justify-center gap-2 rounded-full bg-white px-6 text-[14px] font-semibold text-black font-primary transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
    >
      <svg
        width="16"
        height="16"
