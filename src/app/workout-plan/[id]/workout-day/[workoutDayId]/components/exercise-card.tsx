...
export function ExerciseCard({ exercise }: ExerciseCardProps) {
  ...
  return (
    <div className="w-full min-w-60 rounded-xl border border-[#f1f1f1] p-4 sm:p-5">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-1.5">
          <span className="rounded-full bg-[#f1f1f1] px-2 py-1 text-xs font-semibold text-gray-600 sm:text-sm sm:px-2.5">
            {exercise.sets} séries
          </span>
          <span className="rounded-full bg-[#f1f1f1] px-2 py-1 text-xs font-semibold text-gray-600 sm:text-sm sm:px-2.5">
            {exercise.reps} reps
          </span>
          <div className="flex items-center gap-1 rounded-full bg-[#f1f1f1] px-2 py-1 text-xs font-semibold text-gray-600 sm:text-sm sm:px-2.5">
